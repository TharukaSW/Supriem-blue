...
export declare class AttendanceController {
    ...
    searchEmployees(q: string): Promise<{
        userId: string;
        userCode: string;
        fullName: string;
    }[]>;
    ...
    updateSalaryRange(id: string, dto: UpdateSalaryRangeDto): Promise<{
        salaryRangeId: string;
        isActive: boolean;
        createdAt: Date;
        rangeName: string;
    ...
    updateEmployeeProfile(id: string, dto: UpdateEmployeeProfileDto): Promise<{
        userId: string;
        salaryRangeId: string | undefined;
        salaryRange: {
            isActive: boolean;
    ...
    createSalaryPayment(dto: CreateSalaryPaymentDto, user: any): Promise<{
